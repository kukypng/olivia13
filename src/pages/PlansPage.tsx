      ...
      <div className="relative z-10 container mx-auto px-4 py-12 space-y-20">
        ...
        animationDelay: '0.2s'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
            ...
            return <Card key={index} className="glass-card text-center group hover:scale-105 transition-all duration-300" style={{
          ...
          <div className="max-w-lg mx-auto">
            <Card className="glass-card border-0 shadow-xl relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
              ...
              <div className="relative z-10">
                {/* Popular badge */}
                {config.show_popular_badge && <div className="absolute -top-4 left-1/2 transform -translate-x-1/2">
                    <div className="bg-gradient-to-r from-primary to-primary/80 text-primary-foreground px-6 py-2 rounded-full text-sm font-semibold flex items-center gap-2 shadow-lg mx-0 my-[26px]">
                ...
                <CardContent className="space-y-8 px-8 pb-8">
                  ...
                  <div className="space-y-4">
                    {config.plan_features.map((feature, index) => <div key={index} className="flex items-center gap-4 p-2 rounded-lg hover:bg-accent/20 transition-colors">
                  ...
                  {/* CTA Button */}
                  <Button onClick={handlePlanSelection} className="w-full h-14 text-lg font-semibold rounded-2xl bg-gradient-to-r from-primary to-primary/80 hover:from-primary/90 hover:to-primary/70 text-primary-foreground shadow-lg hover:shadow-xl transition-all duration-300 hover:scale-[1.02] active:scale-[0.98]" size="lg">
                    {config.cta_button_text}
                  </Button>

                  {/* Support Info */}
                  {config.show_support_info && <div className="text-center pt-6 border-t border-border/30">
        ...
        animationDelay: '0.8s'
          ...
          <div className="max-w-3xl mx-auto space-y-4">
            {faqs.map((faq, index) => <Card key={index} className="glass-card transition-all duration-300">
                <CardContent className="p-0">
                  <button onClick={() => setExpandedFaq(expandedFaq === index ? null : index)} className="w-full text-left p-6 focus:outline-none focus:ring-2 focus:ring-primary/20 rounded-2xl">
        ...
        {/* Final CTA */}
        <section className="text-center animate-fade-in-up" style={{
        animationDelay: '1s'
      }}>
